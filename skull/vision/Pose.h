...
static const float NECK_LENGTH = 80.;
static const float CAMERA_YAW_Y_LENGTH = 81.06;
static const float CAMERA_YAW_Z_LENGTH = 14.6;
static const float NECK_BASE_TO_CENTER_Y = 67.5;
static const float NECK_BASE_TO_CENTER_Z = 19.5;
static const float SHOULDER_TO_ELBOW_LENGTH = 69.5;
static const float ELBOW_TO_ELBOW_X = 4.7;
static const float ELBOW_TO_ELBOW_Y = -9.0;
static const float REAR_LEG_LENGTH = 76.5;// 79.4;--UTexas value
static const float REAR_LEG_TO_CENTER_BODY_Y = 65;
static const float REAR_LEG_TO_CENTER_BODY_X = 62.5;
static const float NECK_TILT2_TO_CAMERA_Y = 81.0;
static const float NECK_TILT2_TO_CAMERA_Z = -14.6;
static const float NECK_TILT_TO_TILT2 = 80.0;
static const float SHOULDER_TO_NECK_TILT_Y = 2.5;
static const float SHOULDER_TO_NECK_TILT_Z = 19.5;

// Horizon-Related Constants
static const float MM_TO_PIX_X_PLANE = 0.0171014;
static const float MM_TO_PIX_Y_PLANE = 0.0171195;
static const float HORIZON_LEFT_X_MM = -1.76999;
static const float HORIZON_RIGHT_X_MM = 1.76999;
static const float FOCAL_LENGTH_PIX = 192.0;
static const float FOCAL_LENGTH_MM = 3.27;
static const float IMAGE_CENTER_X = 103.5;
static const float IMAGE_CENTER_Y = 79.5;
static const float HALF_FOV_X_MM = 1.77;
static const float HALF_FOV_Y_MM = 1.361;
static const float IMAGE_MM_WIDTH = 2*tan(FOV_X/2)*FOCAL_LENGTH_MM;
static const float IMAGE_MM_HEIGHT = 2*tan(FOV_Y/2)*FOCAL_LENGTH_MM;
...
// 3d origin constant
static const point3 <float> ZERO_COORD(0,0,0);
// a null estimate struct. zero dist,bearing,elevation (check dist always), x, y
static const estimate NULL_ESTIMATE = {0,0,0,0,0};
...
static const float LINE_HEIGHT = 0.0;
