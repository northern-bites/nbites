...
/* Initializes Variables every frame. 
   Make sure before using any of these variables, to check to see if the ball is in 
   frame by checking distance first (if it's > 0) */
void Ball::init() {
  // Main Variables
  width = 0;
  height = 0;
