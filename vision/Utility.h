...
#include <vector>         // Some functions accept a vector of objects
...
<<<<<<< HEAD:vision/Utility.h
  ...
  static const string getColorString(int _color);

  static const string getCertaintyString(int _cert);

  static const string getDistCertaintyString(int _cert);

  static const string getCornerIDString(int _id);
};
