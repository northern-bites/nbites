...
::TestMessage::NestedTestMessage* (TestMessage::*TestMessage_repeated_nested_message_test_from_index)(int) = &TestMessage::mutable_repeated_nested_message_test;
...
BOOST_PYTHON_MODULE(test_pb2) {
  ...
  scope the_scope = class_<TestMessage>("TestMessage")
    .add_property("string_test", make_function(&TestMessage::string_test, return_value_policy<copy_const_reference>()), (void (TestMessage::*)(const ::std::string&))(&TestMessage::set_string_test))
