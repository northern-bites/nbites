...
IF( WIN32 )
  IF( OE_CROSS_BUILD )
    SET( BOOST_SIGNALS_INCLUDE_DIR ${AL_DIR}/crosstoolchain/staging/geode-linux/usr/include )
    SET( BOOST_SIGNALS_LIBRARIES ${AL_DIR}/crosstoolchain/staging/geode-linux/usr/lib/libboost_signals-mt.so )
  ELSE( OE_CROSS_BUILD )
