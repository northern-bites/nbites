...
IF( WIN32 )
  IF( OE_CROSS_BUILD )
    SET( BOOST_PYTHON_INCLUDE_DIR /usr/include/python2.5 )
    SET( BOOST_PYTHON_LIBRARIES /bin/libpython2.5.dll )
  ELSE( OE_CROSS_BUILD )
    SET( BOOST_PYTHON_INCLUDE_DIR /usr/include/python2.5 )
    SET( BOOST_PYTHON_LIBRARIES /bin/libpython2.5.dll )
...
ELSE( WIN32 )
  ...
  ELSE( OE_CROSS_BUILD )
    SET( BOOST_PYTHON_INCLUDE_DIR /usr/include/python2.5 )
    IF ( APPLE )
      SET( BOOST_PYTHON_LIBRARIES /usr/lib/libpython2.5.dylib )
    ELSE ( APPLE )
      SET( BOOST_PYTHON_LIBRARIES /usr/lib/libpython2.5.so )
    ENDIF( APPLE )
  ENDIF( OE_CROSS_BUILD )
ENDIF( WIN32 )
