...
ELSE( WIN32 )
  IF( OE_CROSS_BUILD )
    SET( BOOST_PYTHON_INCLUDE_DIR ${AL_DIR}/crosstoolchain/staging/geode-linux/usr/include )
    SET( BOOST_PYTHON_LIBRARIES ${AL_DIR}/crosstoolchain/staging/geode-linux/usr/lib/libboost_python-mt.so )
  ELSE( OE_CROSS_BUILD )
    IF ( APPLE )
