...
/* HACK FOR EASING TRANSFER OF THIS LIBRARY! */
#define NBL_STANDALONE
...
#define NBL_CREATE_CONSTANT_METHOD(name, ret)    \
    static const std::string name() { return ret; }

#define NBL_CREATE_INT_CONSTANT_METHOD(name, ret)    \
    static int name() { return ret; }
    ...
    public:
        ...
        NBL_CREATE_CONSTANT_METHOD(SexprType_DEFAULT, "Sexpr")
        NBL_CREATE_CONSTANT_METHOD(JsonType_DEFAULT, "Json")
        NBL_CREATE_CONSTANT_METHOD(LogType_DEFAULT, "_LOG_")

        NBL_CREATE_CONSTANT_METHOD(LogClass_Null, "NullClass")
        NBL_CREATE_CONSTANT_METHOD(LogClass_Flags, "_Flags_")
        NBL_CREATE_CONSTANT_METHOD(LogClass_Tripoint, "tripoint")
        NBL_CREATE_CONSTANT_METHOD(LogClass_YUVImage, "YUVImage")

        NBL_CREATE_CONSTANT_METHOD(LogClass_EdgeImage, "EdgeImage")
        NBL_CREATE_CONSTANT_METHOD(LogClass_String, "String")

        NBL_CREATE_CONSTANT_METHOD(LogClass_RPC_Call, "RPC_Call")
        NBL_CREATE_CONSTANT_METHOD(LogClass_RPC_Return, "RPC_Return")
        NBL_CREATE_CONSTANT_METHOD(RPC_NAME, "RPC_NAME")
        NBL_CREATE_CONSTANT_METHOD(RPC_KEY, "RPC_KEY")

        NBL_CREATE_INT_CONSTANT_METHOD(ROBOT_PORT, 30000)
        NBL_CREATE_INT_CONSTANT_METHOD(CROSS_PORT, 30001)

        NBL_CREATE_INT_CONSTANT_METHOD(REMOTE_HOST_TIMEOUT, 5000000)

        NBL_CREATE_CONSTANT_METHOD(ROBOT_LOG_PATH_PREFIX, "/home/nao/nbites/log/")

        NBL_CREATE_CONSTANT_METHOD(ONLINE_CAMERA_OFFSET_PATH,"")
        NBL_CREATE_CONSTANT_METHOD(ONLINE_COLOR_PARAMS_PATH,"")
        NBL_CREATE_CONSTANT_METHOD(OFFLINE_CAMERA_OFFSET_SUFFIX,"")
        NBL_CREATE_CONSTANT_METHOD(OFFLINE_COLOR_PARAMS_SUFFIX,"")

        NBL_CREATE_CONSTANT_METHOD(LOG_TOPLEVEL_MAGIC_KEY, "#_NBITES_JSON_LOG_VERSION_")

        NBL_CREATE_CONSTANT_METHOD(LOG_TOPLEVEL_BLOCKS, "BLOCKS")
        NBL_CREATE_CONSTANT_METHOD(LOG_TOPLEVEL_LOGCLASS, "CLASS")
        NBL_CREATE_CONSTANT_METHOD(LOG_TOPLEVEL_CREATED_WHEN, "CREATED_WHEN")
        NBL_CREATE_CONSTANT_METHOD(LOG_TOPLEVEL_HOST_TYPE, "HOST_TYPE")
        NBL_CREATE_CONSTANT_METHOD(LOG_TOPLEVEL_HOST_NAME, "HOST_NAME")
        NBL_CREATE_CONSTANT_METHOD(LOG_TOPLEVEL_HOST_ADDR, "HOST_ADDR")

        NBL_CREATE_CONSTANT_METHOD(LOG_BLOCK_TYPE, "TYPE")
        NBL_CREATE_CONSTANT_METHOD(LOG_BLOCK_WHERE_FROM, "WHERE_FROM")
        NBL_CREATE_CONSTANT_METHOD(LOG_BLOCK_WHEN_MADE, "WHEN_MADE")
        NBL_CREATE_CONSTANT_METHOD(LOG_BLOCK_IMAGE_INDEX, "IMAGE_INDEX")
        NBL_CREATE_CONSTANT_METHOD(LOG_BLOCK_NUM_BYTES, "NUM_BYTES")

        NBL_CREATE_CONSTANT_METHOD(LOG_BLOCK_IMAGE_WIDTH_PIXELS, "WIDTH_PIXELS")
        NBL_CREATE_CONSTANT_METHOD(LOG_BLOCK_IMAGE_HEIGHT_PIXELS, "HEIGHT_PIXELS")
    };
