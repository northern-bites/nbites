...
LANDMARK_MY_GOAL_TOP_POST_X = FIELD_WHITE_LEFT_SIDELINE_X + GOAL_POST_RADIUS
LANDMARK_MY_GOAL_BOTTOM_POST_X = FIELD_WHITE_LEFT_SIDELINE_X + GOAL_POST_RADIUS
LANDMARK_OPP_GOAL_TOP_POST_X = FIELD_WHITE_RIGHT_SIDELINE_X - GOAL_POST_RADIUS
LANDMARK_OPP_GOAL_BOTTOM_POST_X = FIELD_WHITE_RIGHT_SIDELINE_X - GOAL_POST_RADIUS

# measure to the center of the posts, 5 cm off the line
LANDMARK_MY_GOAL_TOP_POST_Y = CENTER_FIELD_Y + CROSSBAR_CM_WIDTH / 2.0
LANDMARK_MY_GOAL_BOTTOM_POST_Y = CENTER_FIELD_Y - CROSSBAR_CM_WIDTH / 2.0
LANDMARK_OPP_GOAL_TOP_POST_Y = CENTER_FIELD_Y + CROSSBAR_CM_WIDTH / 2.0
LANDMARK_OPP_GOAL_BOTTOM_POST_Y = CENTER_FIELD_Y - CROSSBAR_CM_WIDTH / 2.0
