...
legend("topleft",lty=c(1,2,3,4,5), c("Truth", "EKF", "MCL 100", "EKF-NA", "MCL 50"), col=c("green", "red", "blue", "purple","brown"))
dev.off()
...
legend("topright",lty=c(1,2,3,4,5), c("Truth", "EKF", "MCL 100", "EKF-NA", "MCL 50"), col=c("green", "red", "blue", "purple","brown"))
dev.off()
...
points(frames, mclX100, lty = 3, col = "blue", type="l", lwd="2")
legend("topleft",lty=c(1,3,5), c("Truth", "MCL", "MCL best"), col=c("green", "blue", "red"))
dev.off()
...
points(frames, mclY100, lty = 3, col = "blue", type="l",lwd="2")
legend("top",lty=c(1,3,5), c("Truth", "MCL", "MCL best"), col=c("green", "blue", "red"))
dev.off()
...
legend("topleft",lty=c(1,2,3,4,5), c("Truth", "EKF", "MCL 100", "EKF-NA", "MCL 500"), col=c("green", "red", "blue", "pink", "purple"))
dev.off()
...
mcl5Hrms.1 <-  sqrt(sum((mcldata5[,"h est"] - knownH)^2)/length(knownH))
mcl10Hrms.1 <- sqrt(sum((mcldata10[,"h est"] - knownH)^2)/length(knownH))
mcl50Hrms.1 <- sqrt(sum((mcldata50[,"h est"] - knownH)^2)/length(knownH))
mcl100Hrms.1 <- sqrt(sum((mcldata100[,"h est"] - knownH)^2)/length(knownH))
mcl500Hrms.1 <- sqrt(sum((mcldata500[,"h est"] - knownH)^2)/length(knownH))
mcl1000Hrms.1 <- sqrt(sum((mcldata1000[,"h est"] - knownH)^2)/length(knownH))
mcl5bestHrms.1 <-  sqrt(sum((mcldata5best[,"h est"] - knownH)^2)/length(knownH))
mcl10bestHrms.1 <- sqrt(sum((mcldata10best[,"h est"] - knownH)^2)/length(knownH))
mcl50bestHrms.1 <- sqrt(sum((mcldata50best[,"h est"] - knownH)^2)/length(knownH))
mcl100bestHrms.1 <- sqrt(sum((mcldata100best[,"h est"] - knownH)^2)/length(knownH))
mcl500bestHrms.1 <- sqrt(sum((mcldata500best[,"h est"] - knownH)^2)/length(knownH))
mcl1000bestHrms.1 <- sqrt(sum((mcldata1000best[,"h est"] - knownH)^2)/length(knownH))

mcl5Hrms.2 <-  sqrt(sum((mcldata5[,"h est"] - knownH)^2)/length(knownH))
mcl10Hrms.2 <- sqrt(sum((mcldata10[,"h est"] - knownH)^2)/length(knownH))
mcl50Hrms.2 <- sqrt(sum((mcldata50[,"h est"] - knownH)^2)/length(knownH))
mcl100Hrms.2 <- sqrt(sum((mcldata100[,"h est"] - knownH)^2)/length(knownH))
mcl500Hrms.2 <- sqrt(sum((mcldata500[,"h est"] - knownH)^2)/length(knownH))
mcl1000Hrms.2 <- sqrt(sum((mcldata1000[,"h est"] - knownH)^2)/length(knownH))
mcl5bestHrms.2 <-  sqrt(sum((mcldata5best[,"h est"] - knownH)^2)/length(knownH))
mcl10bestHrms.2 <- sqrt(sum((mcldata10best[,"h est"] - knownH)^2)/length(knownH))
mcl50bestHrms.2 <- sqrt(sum((mcldata50best[,"h est"] - knownH)^2)/length(knownH))
mcl100bestHrms.2 <- sqrt(sum((mcldata100best[,"h est"] - knownH)^2)/length(knownH))
mcl500bestHrms.2 <- sqrt(sum((mcldata500best[,"h est"] - knownH)^2)/length(knownH))
mcl1000bestHrms.2 <- sqrt(sum((mcldata1000best[,"h est"] - knownH)^2)/length(knownH))


mcl5Hrms.3 <-  sqrt(sum((mcldata5[,"h est"] - knownH)^2)/length(knownH))
mcl10Hrms.3 <- sqrt(sum((mcldata10[,"h est"] - knownH)^2)/length(knownH))
mcl50Hrms.3 <- sqrt(sum((mcldata50[,"h est"] - knownH)^2)/length(knownH))
mcl100Hrms.3 <- sqrt(sum((mcldata100[,"h est"] - knownH)^2)/length(knownH))
mcl500Hrms.3 <- sqrt(sum((mcldata500[,"h est"] - knownH)^2)/length(knownH))
mcl1000Hrms.3 <- sqrt(sum((mcldata1000[,"h est"] - knownH)^2)/length(knownH))
mcl5bestHrms.3 <-  sqrt(sum((mcldata5best[,"h est"] - knownH)^2)/length(knownH))
mcl10bestHrms.3 <- sqrt(sum((mcldata10best[,"h est"] - knownH)^2)/length(knownH))
mcl50bestHrms.3 <- sqrt(sum((mcldata50best[,"h est"] - knownH)^2)/length(knownH))
mcl100bestHrms.3 <- sqrt(sum((mcldata100best[,"h est"] - knownH)^2)/length(knownH))
mcl500bestHrms.3 <- sqrt(sum((mcldata500best[,"h est"] - knownH)^2)/length(knownH))
mcl1000bestHrms.3 <- sqrt(sum((mcldata1000best[,"h est"] - knownH)^2)/length(knownH))

mcl5Hrms.4 <-  sqrt(sum((mcldata5[,"h est"] - knownH)^2)/length(knownH))
mcl10Hrms.4 <- sqrt(sum((mcldata10[,"h est"] - knownH)^2)/length(knownH))
mcl50Hrms.4 <- sqrt(sum((mcldata50[,"h est"] - knownH)^2)/length(knownH))
mcl100Hrms.4 <- sqrt(sum((mcldata100[,"h est"] - knownH)^2)/length(knownH))
mcl500Hrms.4 <- sqrt(sum((mcldata500[,"h est"] - knownH)^2)/length(knownH))
mcl1000Hrms.4 <- sqrt(sum((mcldata1000[,"h est"] - knownH)^2)/length(knownH))
mcl5bestHrms.4 <-  sqrt(sum((mcldata5best[,"h est"] - knownH)^2)/length(knownH))
mcl10bestHrms.4 <- sqrt(sum((mcldata10best[,"h est"] - knownH)^2)/length(knownH))
mcl50bestHrms.4 <- sqrt(sum((mcldata50best[,"h est"] - knownH)^2)/length(knownH))
mcl100bestHrms.4 <- sqrt(sum((mcldata100best[,"h est"] - knownH)^2)/length(knownH))
mcl500bestHrms.4 <- sqrt(sum((mcldata500best[,"h est"] - knownH)^2)/length(knownH))
mcl1000bestHrms.4 <- sqrt(sum((mcldata1000best[,"h est"] - knownH)^2)/length(knownH))

mcl5Hrms.5 <-  sqrt(sum((mcldata5[,"h est"] - knownH)^2)/length(knownH))
mcl10Hrms.5 <- sqrt(sum((mcldata10[,"h est"] - knownH)^2)/length(knownH))
mcl50Hrms.5 <- sqrt(sum((mcldata50[,"h est"] - knownH)^2)/length(knownH))
mcl100Hrms.5 <- sqrt(sum((mcldata100[,"h est"] - knownH)^2)/length(knownH))
mcl500Hrms.5 <- sqrt(sum((mcldata500[,"h est"] - knownH)^2)/length(knownH))
mcl1000Hrms.5 <- sqrt(sum((mcldata1000[,"h est"] - knownH)^2)/length(knownH))
mcl5bestHrms.5 <-  sqrt(sum((mcldata5best[,"h est"] - knownH)^2)/length(knownH))
mcl10bestHrms.5 <- sqrt(sum((mcldata10best[,"h est"] - knownH)^2)/length(knownH))
mcl50bestHrms.5 <- sqrt(sum((mcldata50best[,"h est"] - knownH)^2)/length(knownH))
mcl100bestHrms.5 <- sqrt(sum((mcldata100best[,"h est"] - knownH)^2)/length(knownH))
mcl500bestHrms.5 <- sqrt(sum((mcldata500best[,"h est"] - knownH)^2)/length(knownH))
mcl1000bestHrms.5 <- sqrt(sum((mcldata1000best[,"h est"] - knownH)^2)/length(knownH))

mcl5Hrms.6 <-  sqrt(sum((mcldata5[,"h est"] - knownH)^2)/length(knownH))
mcl10Hrms.6 <- sqrt(sum((mcldata10[,"h est"] - knownH)^2)/length(knownH))
mcl50Hrms.6 <- sqrt(sum((mcldata50[,"h est"] - knownH)^2)/length(knownH))
mcl100Hrms.6 <- sqrt(sum((mcldata100[,"h est"] - knownH)^2)/length(knownH))
mcl500Hrms.6 <- sqrt(sum((mcldata500[,"h est"] - knownH)^2)/length(knownH))
mcl1000Hrms.6 <- sqrt(sum((mcldata1000[,"h est"] - knownH)^2)/length(knownH))
mcl5bestHrms.6 <-  sqrt(sum((mcldata5best[,"h est"] - knownH)^2)/length(knownH))
mcl10bestHrms.6 <- sqrt(sum((mcldata10best[,"h est"] - knownH)^2)/length(knownH))
mcl50bestHrms.6 <- sqrt(sum((mcldata50best[,"h est"] - knownH)^2)/length(knownH))
mcl100bestHrms.6 <- sqrt(sum((mcldata100best[,"h est"] - knownH)^2)/length(knownH))
mcl500bestHrms.6 <- sqrt(sum((mcldata500best[,"h est"] - knownH)^2)/length(knownH))
mcl1000bestHrms.6 <- sqrt(sum((mcldata1000best[,"h est"] - knownH)^2)/length(knownH))

mcl5Hrms.7 <-  sqrt(sum((mcldata5[,"h est"] - knownH)^2)/length(knownH))
mcl10Hrms.7 <- sqrt(sum((mcldata10[,"h est"] - knownH)^2)/length(knownH))
mcl50Hrms.7 <- sqrt(sum((mcldata50[,"h est"] - knownH)^2)/length(knownH))
mcl100Hrms.7 <- sqrt(sum((mcldata100[,"h est"] - knownH)^2)/length(knownH))
mcl500Hrms.7 <- sqrt(sum((mcldata500[,"h est"] - knownH)^2)/length(knownH))
mcl1000Hrms.7 <- sqrt(sum((mcldata1000[,"h est"] - knownH)^2)/length(knownH))
mcl5bestHrms.7 <-  sqrt(sum((mcldata5best[,"h est"] - knownH)^2)/length(knownH))
mcl10bestHrms.7 <- sqrt(sum((mcldata10best[,"h est"] - knownH)^2)/length(knownH))
mcl50bestHrms.7 <- sqrt(sum((mcldata50best[,"h est"] - knownH)^2)/length(knownH))
mcl100bestHrms.7 <- sqrt(sum((mcldata100best[,"h est"] - knownH)^2)/length(knownH))
mcl500bestHrms.7 <- sqrt(sum((mcldata500best[,"h est"] - knownH)^2)/length(knownH))
mcl1000bestHrms.7 <- sqrt(sum((mcldata1000best[,"h est"] - knownH)^2)/length(knownH))

mcl5Hrms.8 <-  sqrt(sum((mcldata5[,"h est"] - knownH)^2)/length(knownH))
mcl10Hrms.8 <- sqrt(sum((mcldata10[,"h est"] - knownH)^2)/length(knownH))
mcl50Hrms.8 <- sqrt(sum((mcldata50[,"h est"] - knownH)^2)/length(knownH))
mcl100Hrms.8 <- sqrt(sum((mcldata100[,"h est"] - knownH)^2)/length(knownH))
mcl500Hrms.8 <- sqrt(sum((mcldata500[,"h est"] - knownH)^2)/length(knownH))
mcl1000Hrms.8 <- sqrt(sum((mcldata1000[,"h est"] - knownH)^2)/length(knownH))
mcl5bestHrms.8 <-  sqrt(sum((mcldata5best[,"h est"] - knownH)^2)/length(knownH))
mcl10bestHrms.8 <- sqrt(sum((mcldata10best[,"h est"] - knownH)^2)/length(knownH))
mcl50bestHrms.8 <- sqrt(sum((mcldata50best[,"h est"] - knownH)^2)/length(knownH))
mcl100bestHrms.8 <- sqrt(sum((mcldata100best[,"h est"] - knownH)^2)/length(knownH))
mcl500bestHrms.8 <- sqrt(sum((mcldata500best[,"h est"] - knownH)^2)/length(knownH))
mcl1000bestHrms.8 <- sqrt(sum((mcldata1000best[,"h est"] - knownH)^2)/length(knownH))
mcl5Hrms.9 <-  sqrt(sum((mcldata5[,"h est"] - knownH)^2)/length(knownH))
mcl10Hrms.9 <- sqrt(sum((mcldata10[,"h est"] - knownH)^2)/length(knownH))
mcl50Hrms.9 <- sqrt(sum((mcldata50[,"h est"] - knownH)^2)/length(knownH))
mcl100Hrms.9 <- sqrt(sum((mcldata100[,"h est"] - knownH)^2)/length(knownH))
mcl500Hrms.9 <- sqrt(sum((mcldata500[,"h est"] - knownH)^2)/length(knownH))
mcl1000Hrms.9 <- sqrt(sum((mcldata1000[,"h est"] - knownH)^2)/length(knownH))
mcl5bestHrms.9 <-  sqrt(sum((mcldata5best[,"h est"] - knownH)^2)/length(knownH))
mcl10bestHrms.9 <- sqrt(sum((mcldata10best[,"h est"] - knownH)^2)/length(knownH))
mcl50bestHrms.9 <- sqrt(sum((mcldata50best[,"h est"] - knownH)^2)/length(knownH))
mcl100bestHrms.9 <- sqrt(sum((mcldata100best[,"h est"] - knownH)^2)/length(knownH))
mcl500bestHrms.9 <- sqrt(sum((mcldata500best[,"h est"] - knownH)^2)/length(knownH))
mcl1000bestHrms.9 <- sqrt(sum((mcldata1000best[,"h est"] - knownH)^2)/length(knownH))
mcl5Hrms.10 <-  sqrt(sum((mcldata5[,"h est"] - knownH)^2)/length(knownH))
mcl10Hrms.10 <- sqrt(sum((mcldata10[,"h est"] - knownH)^2)/length(knownH))
mcl50Hrms.10 <- sqrt(sum((mcldata50[,"h est"] - knownH)^2)/length(knownH))
mcl100Hrms.10 <- sqrt(sum((mcldata100[,"h est"] - knownH)^2)/length(knownH))
mcl500Hrms.10 <- sqrt(sum((mcldata500[,"h est"] - knownH)^2)/length(knownH))
mcl1000Hrms.10 <- sqrt(sum((mcldata1000[,"h est"] - knownH)^2)/length(knownH))
mcl5bestHrms.10 <-  sqrt(sum((mcldata5best[,"h est"] - knownH)^2)/length(knownH))
mcl10bestHrms.10 <- sqrt(sum((mcldata10best[,"h est"] - knownH)^2)/length(knownH))
mcl50bestHrms.10 <- sqrt(sum((mcldata50best[,"h est"] - knownH)^2)/length(knownH))
mcl100bestHrms.10 <- sqrt(sum((mcldata100best[,"h est"] - knownH)^2)/length(knownH))
mcl500bestHrms.10 <- sqrt(sum((mcldata500best[,"h est"] - knownH)^2)/length(knownH))
mcl1000bestHrms.10 <- sqrt(sum((mcldata1000best[,"h est"] - knownH)^2)/length(knownH))
