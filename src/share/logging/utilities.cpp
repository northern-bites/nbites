...
namespace nbl {
    namespace utilities {
        ...
        color_string RED = "\x1b[31m", GREEN = "\x1b[32m", YELLOW = "\x1b[33m", BLUE = "\x1b[34m",
            MAGENTA = "\x1b[35m", CYAN = "\x1b[36m", BOLD_YELLOW = "\x1b[33;1m",
            BOLD_RED = "\x1b[31;1m", RESET = "\x1b[0m";

        color_string LevelColors[] = {
            CYAN, BOLD_YELLOW, BOLD_RED, RESET
        };
    ...
    namespace test {
        ...
        void init_all_tests() {
            if (all_tests == nullptr) {
                ...
                if (mayUseColor()) {
                    test_section_color = YELLOW;
                    test_start_color = CYAN;
                    test_passed_color = GREEN;
                    test_failed_color = RED;
                    test_post_color = RESET;
                }
