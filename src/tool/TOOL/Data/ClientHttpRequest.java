...
/**
 * Removed all non-type safe code to clean up our TOOL-base :-).
 * If you need the functionality of the setParameters() function with multiple
 * types in a single array or map (and thus most of the numerous helper
 * functions commented out here), please create an interface or extendable
 * class for the Strings, Files, etc
 *   - jfishman@
 */
