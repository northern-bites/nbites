/**
 * This is in charge of drawing various things on the field
 */
    ...
    scaleFactor(scaleFactor_)
{
    ...
    authorName->setText("EJ");

    rightLayout->addWidget(authorName);
...
{
    return QSize(FIELD_GREEN_WIDTH * scaleFactor,
                 FIELD_GREEN_HEIGHT * scaleFactor);
}
