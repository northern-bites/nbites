...
public class OldCppPane extends JPanel implements ActionListener, NListener, CppFuncListener {
	private static final long serialVersionUID = 1L;

	protected OldCppPane(LogChooser lc) {
		super();
	...
	private String tryCall() {
		...
		CppIO.CppFuncCall call = new CppFuncCall();
