...
public class BasicLineView extends ViewParent implements IOFirstResponder {
    ...
    public void ioReceived(IOInstance inst, int ret, Log... out) {
        ...
        try {
            ...
            Logger.logf(Logger.ERROR, "Conversion from bytes to hough coord lines in BasicLineView failed.");
            e.printStackTrace();
        }
    }
