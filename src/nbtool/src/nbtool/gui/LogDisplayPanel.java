...
public class LogDisplayPanel extends JPanel implements 
	...
	protected LogDisplayPanel(boolean isMain) {
		...
		//Should be set from footer init.
		assert(this.profile == ViewProfile.DEFAULT_PROFILE);	
		...
		for (int i = 0; i < list.length; ++i) {
			...
			if (slip) {
				...
				try {
					...
					tabs.addTab(ttype.getSimpleName(), view);
	...
	private void finishedLoading(int tindex, ViewParent newView) {
		...
		tabs.setComponentAt(tindex, newView);
		newView.repaint();
	}
	...
	private class DisplayFooter extends javax.swing.JPanel {
	    ...
	    private void initComponents() {
	        ...
	        layout.setHorizontalGroup(
	            ...
	            .addGroup(layout.createSequentialGroup()
	                ...
	                .addComponent(streamField, javax.swing.GroupLayout.DEFAULT_SIZE, 255, Short.MAX_VALUE)
	                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
	    ...
	    public javax.swing.JCheckBox streamBox;
	    public javax.swing.JTextField streamField;
