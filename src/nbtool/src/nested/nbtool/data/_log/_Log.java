...
public class _Log {
	...
	public static _Log logWithType(String type) {
		return _Log.logWithType(type, null);
	}
	
	public static _Log logWithType(String type, byte[] b) {
		...
		return new _Log(topLevel, b);
	}
	
	public static _Log logWithTypePlus(String type, byte[] b, SExpr... fields) {
		SExpr typeField = SExpr.newKeyValue(CONTENT_TYPE_S, type);
		SExpr fieldList = SExpr.newList(typeField);
	...
	public static _Log simpleCommandLog(String cmndName, byte[] bytes) {
