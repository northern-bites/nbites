...
import nbtool.gui.utilitypanes.CameraCalibrateUtility2.CCU_Frame;
...
public class CameraSettingsUtility extends UtilityParent {
	...
	private class CSU_Frame extends JFrame implements ActionListener {
		public CSU_Frame() {
			/*
			 GUI is done below. 
		...
		private void tryStream(Integer[] topCameraParams, Integer[] bottomCameraParams) {
			...
			if (first == null) {
				Debug.warn( "CameraParams clicked when no ControlIO instance available");
				return;
			}
