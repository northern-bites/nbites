...
public class OptionsAndUtilities extends JPanel{
	...
	protected OptionsAndUtilities() {
		...
		levelBox.setModel(new DefaultComboBoxModel<Debug.LogLevel>(Debug.LogLevel.values()));
		levelBox.setEditable(false);
		levelBox.setSelectedIndex(Arrays.asList(Debug.LogLevel.values()).indexOf(Debug.level));
    ...
    private javax.swing.JComboBox<Debug.LogLevel> levelBox;
