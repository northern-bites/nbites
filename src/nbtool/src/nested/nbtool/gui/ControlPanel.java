...
public class ControlPanel extends JPanel implements Events.LogsFound, Events.LogSelected,
	...
	public ControlPanel() {
		...
		dirBox.setModel(new DefaultComboBoxModel<String>( updateList(UserSettings.filepaths, null)));
		addrBox.setModel(new DefaultComboBoxModel<String>( updateList(UserSettings.addresses, null)));
