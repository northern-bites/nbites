...
static const robot_ip_pair robotIPs[NUM_ROBOTS] = {wash, river, jayne,
                                                   simon, inara, kaylee,
                                                   vera, mal, zoe, groot, elektra,
                                                   wasp, blt, batman, shehulk};
