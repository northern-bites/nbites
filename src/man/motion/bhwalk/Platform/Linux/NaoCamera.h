...
public:
  ...
  */
  NaoCamera(const char* device, CameraInfoBH::Camera camera, int width, int height, bool flip);
  ...
  */
  void setSettings(const CameraSettingsBH& settings);

  /**
  * Requests the current camera control settings of the camera.
  * @return The settings.
  */
  const CameraSettingsBH& getSettings() const { return settings; };
  ...
  */
  CameraInfoBH::Camera getCurrentCamera() { return camera; }
...
private:
  CameraSettingsBH settings; /**< The camera control settings. */
  CameraSettingsBH appliedSettings; /**< The camera settings that are known to be applied. */
  ...
  CameraInfoBH::Camera camera; /**< The camera accessed by this driver. */
  ...
  */
   ...
   */
  bool setControlSettings(std::list<CameraSettingsBH::V4L2Setting> controlsettings,
