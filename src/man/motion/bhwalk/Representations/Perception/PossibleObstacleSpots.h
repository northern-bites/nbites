...
class PossibleObstacleSpotsBH : public Streamable
{
...
public:
  ...
  void draw() const
  {
    DECLARE_DEBUG_DRAWING("representation:PossibleObstacleSpotsBH", "drawingOnImage");
    ...
    for(int i = 0; i < scanlineCount; ++i)
    {
      ...
      {
        CROSS("representation:PossibleObstacleSpotsBH", line.xImg, line.spots[j], 2, 2, Drawings::ps_solid, ColorClasses::red);
      }
    }
  }
};
