...
JPEGImage::JPEGImage(const ImageBH& image)
{
  *this = image;
}

JPEGImage& JPEGImage::operator=(const ImageBH& src)
{
...
void JPEGImage::toImage(ImageBH& dest) const
{
...
void JPEGImage::toAiboAlignment(const unsigned char* src, unsigned char* dst) const
{
  ...
  {
    //0xFF, 0xFF, 0xFF, 0xFF,
    offsetof(ImageBH::Pixel, cb), offsetof(ImageBH::Pixel, cb) + 4, offsetof(ImageBH::Pixel, cb) + 8, offsetof(ImageBH::Pixel, cb) + 12,
    offsetof(ImageBH::Pixel, y), offsetof(ImageBH::Pixel, y) + 4, offsetof(ImageBH::Pixel, y) + 8, offsetof(ImageBH::Pixel, y) + 12,
    offsetof(ImageBH::Pixel, cr), offsetof(ImageBH::Pixel, cr) + 4, offsetof(ImageBH::Pixel, cr) + 8, offsetof(ImageBH::Pixel, cr) + 12,
    //0xFF, 0xFF, 0xFF, 0xFF,
    0xFF, 0xFF, 0xFF, 0xFF
  };
