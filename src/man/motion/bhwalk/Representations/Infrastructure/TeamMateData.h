...
public:
  ...
  (BallModelBH[numOfPlayers]) ballModels, /**< The last received ball model of each team mate. */
  (ObstacleModelBH[numOfPlayers]) obstacleModels, /**< The last received obstacle model of each team mate. */
  (RobotsModelBH[numOfPlayers]) robotsModels, /**< The last received robots model of each team mate. */
  (RobotPoseBH[numOfPlayers]) robotPoses, /**< The last received robot pose of each team mate. */
  (SideConfidenceBH[numOfPlayers]) robotsSideConfidence, /**< The last received sideConfidence of each team mate. */
  ...
  (FieldCoverageBH::GridInterval[numOfPlayers]) fieldCoverages, /**< The last received field coverage grid of each team mate. */
  (ObstacleClustersBH[numOfPlayers]) obstacleClusters, /**< The last received obstacle clusters */
 ...
 */
STREAMABLE(TeamDataSenderOutputBH,
{,
});
