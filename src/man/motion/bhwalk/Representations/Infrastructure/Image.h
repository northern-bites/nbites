...
*/
class ImageBH : public Streamable
{
public:
  /**
  ...
  */
  ImageBH(bool initialize = true, int width = maxResolutionWidth, int height = maxResolutionHeight);
  ...
  * @return This image.
  */
  ImageBH& operator=(const ImageBH& other);
  ...
  */
   ...
   * @return The distance
   */
  static float getColorDistance(const ImageBH::Pixel& a, const ImageBH::Pixel& b);
...
class ImageOther : public ImageBH {};
