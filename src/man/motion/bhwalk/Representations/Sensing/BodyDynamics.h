...
{
public:
  BodyDynamics(const MassCalibrationBH& massCalibration) {init(massCalibration);}

  void init(const MassCalibrationBH& massCalibration),

  (bool)(false) inertiasInitialized, /**< True if the inertia matrices have been set. */
  (Body[MassCalibrationBH::numOfLimbs]) limbs,
...
public:
  ...
  (Derivative[JointDataBH::numOfJoints]) partialDerivatives, /**< The partial derivatives of the composite force by the joint dynamics at the support foot. */
