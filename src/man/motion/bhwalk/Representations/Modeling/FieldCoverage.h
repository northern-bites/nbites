...
public:
  ...
  public:
    ...
    static Vector2BH<int> index2CellCoordinates(int idx) { return Vector2BH<int>(idx / ySteps, idx % ySteps); }
  ...
  public:
    ...
    Target(const Vector2BH<>& target, unsigned short coverage = 0, bool valid = true),
