...
STREAMABLE(GlobalFieldCoverageBH,
{
public:
  STREAMABLE(Grid,
  {
  public:
    ...
    (unsigned[FieldCoverageBH::GridInterval::xSteps * FieldCoverageBH::GridInterval::ySteps]) cells,
  ...
  (Vector2BH<>) patrolTarget, /**< Target the robot should try to approach while patrolling. */
