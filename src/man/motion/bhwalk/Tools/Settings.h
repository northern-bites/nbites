...
public:
  ...
  (int)(0) teamNumber, /**< The number of our team in the game controller. Use theOwnTeamInfoBH.teamNumber instead. */
  (TeamColor)(blue) teamColor, /**< The color of our team. Use theOwnTeamInfoBH.teamColour instead. */
  (int)(0) playerNumber, /**< The number of the robot in the team. Use theRobotInfoBH.playerNumber instead. */
