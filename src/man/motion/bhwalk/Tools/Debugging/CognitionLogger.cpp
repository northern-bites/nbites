...
#include <vector>
#include "snappy-c.h"
#include "Tools/ModuleBH/ModuleManager.h"
...
{
  REGISTER_REPRESENTATION(RobotPoseBH);
  REGISTER_REPRESENTATION(BallPerceptBH);
  REGISTER_REPRESENTATION(LinePerceptBH);
  REGISTER_REPRESENTATION(FieldBoundaryBH);
  REGISTER_REPRESENTATION(ImageCoordinateSystemBH);
  REGISTER_REPRESENTATION(GoalPerceptBH);
  REGISTER_REPRESENTATION(RobotsModelBH);
  REGISTER_REPRESENTATION(BallModelBH);
  REGISTER_REPRESENTATION(CombinedWorldModelBH);
  REGISTER_REPRESENTATION(CameraMatrixBH);
  REGISTER_REPRESENTATION(ObstacleModelBH);
  REGISTER_REPRESENTATION(BehaviorControlOutputBH);
  REGISTER_REPRESENTATION(MotionRequestBH);
  REGISTER_REPRESENTATION(FilteredJointDataBH);
  REGISTER_REPRESENTATION(FrameInfoBH);
  REGISTER_REPRESENTATION(SideConfidenceBH);
  REGISTER_REPRESENTATION(FilteredSensorDataBH);
  REGISTER_REPRESENTATION(GameInfoBH);
  REGISTER_REPRESENTATION(OwnTeamInfoBH);
  REGISTER_REPRESENTATION(MotionInfoBH);
  REGISTER_REPRESENTATION(RobotHealthBH);
  REGISTER_REPRESENTATION(ColorReferenceBH);
  REGISTER_REPRESENTATION(ThumbnailBH);
  REGISTER_REPRESENTATION(ActivationGraphBH);
  REGISTER_REPRESENTATION(CameraInfoBH);
  REGISTER_REPRESENTATION(ObstacleSpotsBH);
  REGISTER_REPRESENTATION(ObstacleWheelBH);
  REGISTER_REPRESENTATION(BodyContourBH);
}
...
{
  const int gameState = Blackboard::theInstance->theGameInfoBH.state;
