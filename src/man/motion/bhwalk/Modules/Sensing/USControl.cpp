...
void USControl::update(USRequestBH& usRequest)
{
  if(stopOnPlayDead &&
     theMotionRequestBH.motion == MotionRequestBH::specialAction &&
     theMotionRequestBH.specialActionRequest.specialAction == SpecialActionRequest::playDead)
  {
