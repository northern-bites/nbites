...
class UNSWCamera {
   public:
       ...
       *
       * @param whichUNSWCamera specifies the top or bottom camera to switch to
       * @return whether the set succeeds
       * @sideeffect stops capturing, switches the camera, then starts again
       */
      virtual bool setUNSWCamera(WhichCamera whichUNSWCamera) = 0;
       ...
       */
      virtual WhichCamera getUNSWCamera() = 0;
