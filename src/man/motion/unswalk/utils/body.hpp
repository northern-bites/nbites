...
namespace Joints {
   ...
   namespace Radians {
      const float HeadYaw_Min          = UNSWDEG2RAD(-119.5);
      const float HeadYaw_Max          = UNSWDEG2RAD(119.5);
      const float HeadPitch_Min        = UNSWDEG2RAD(-38.5);
      const float HeadPitch_Max        = UNSWDEG2RAD(29.5);
      const float LShoulderPitch_Min   = UNSWDEG2RAD(-119.5);
      const float LShoulderPitch_Max   = UNSWDEG2RAD(119.5);
      const float LShoulderRoll_Max    = UNSWDEG2RAD(76);
      const float LShoulderRoll_Min    = UNSWDEG2RAD(-18);
      const float LElbowYaw_Min        = UNSWDEG2RAD(-119.5);
      const float LElbowYaw_Max        = UNSWDEG2RAD(119.5);
      const float LElbowRoll_Min       = UNSWDEG2RAD(-88.5);
      const float LElbowRoll_Max       = UNSWDEG2RAD(-2);
      const float LWristYaw_Min        = UNSWDEG2RAD(-104.5);
      const float LWristYaw_Max        = UNSWDEG2RAD(104.5);
      const float LHand_Min            = 0.0;
      const float LHand_Max            = 1.0;
      const float LHipYawPitch_Min     = UNSWDEG2RAD(-65.62);
      const float LHipYawPitch_Max     = UNSWDEG2RAD(42.44);
      const float LHipPitch_Min        = UNSWDEG2RAD(-101.63);
      const float LHipPitch_Max        = UNSWDEG2RAD(27.73);
      const float LHipRoll_Min         = UNSWDEG2RAD(-21.74);
      const float LHipRoll_Max         = UNSWDEG2RAD(45.29);
      const float LKneePitch_Min       = UNSWDEG2RAD(-5.29);
      const float LKneePitch_Max       = UNSWDEG2RAD(121.04);
      const float LAnklePitch_Min      = UNSWDEG2RAD(-68.15);
      const float LAnklePitch_Max      = UNSWDEG2RAD(52.86);
      const float LAnkleRoll_Min       = UNSWDEG2RAD(-22.79);
      const float LAnkleRoll_Max       = UNSWDEG2RAD(44.06);
      const float RHipPitch_Min        = UNSWDEG2RAD(-101.54);
      const float RHipPitch_Max        = UNSWDEG2RAD(27.82);
      const float RHipRoll_Min         = UNSWDEG2RAD(-42.30);
      const float RHipRoll_Max         = UNSWDEG2RAD(23.76);
      const float RKneePitch_Min       = UNSWDEG2RAD(-5.90);
      const float RKneePitch_Max       = UNSWDEG2RAD(121.47);
      const float RAnklePitch_Min      = UNSWDEG2RAD(-67.97);
      const float RAnklePitch_Max      = UNSWDEG2RAD(53.40);
      const float RAnkleRoll_Min       = UNSWDEG2RAD(-45.03);
      const float RAnkleRoll_Max       = UNSWDEG2RAD(22.27);
      const float RShoulderPitch_Min   = UNSWDEG2RAD(-119.5);
      const float RShoulderPitch_Max   = UNSWDEG2RAD(119.5);
      const float RShoulderRoll_Min    = UNSWDEG2RAD(-76);
      const float RShoulderRoll_Max    = UNSWDEG2RAD(18);
      const float RElbowYaw_Min        = UNSWDEG2RAD(-119.5);
      const float RElbowYaw_Max        = UNSWDEG2RAD(119.5);
      const float RElbowRoll_Min       = UNSWDEG2RAD(2);
      const float RElbowRoll_Max       = UNSWDEG2RAD(88.5);
      const float RWristYaw_Min        = UNSWDEG2RAD(-104.5);
      const float RWristYaw_Max        = UNSWDEG2RAD(104.5);
   ...
   namespace Radians {
      ...
      const float MOTOR1_REDUCTIONA_RAD = UNSWDEG2RAD(2.23);
      const float MOTOR1_REDUCTIONB_RAD = UNSWDEG2RAD(3.43);
      const float MOTOR2_REDUCTIONA_RAD = UNSWDEG2RAD(8.96);
      const float MOTOR2_REDUCTIONB_RAD = UNSWDEG2RAD(12.52);
      const float MOTOR3_REDUCTIONA_RAD = UNSWDEG2RAD(3.85);
      const float MOTOR3_REDUCTIONB_RAD = UNSWDEG2RAD(3.34);
...
namespace Sonar {
   ...
   const float RIGHT_START = UNSWDEG2RAD(-70.f); 
   const float RIGHT_END = UNSWDEG2RAD(10.f);
   const float MIDDLE_START = UNSWDEG2RAD(-20.f); 
   const float MIDDLE_END = UNSWDEG2RAD(20.f);
   const float LEFT_START = UNSWDEG2RAD(-10.f);
   const float LEFT_END = UNSWDEG2RAD(70.f);
