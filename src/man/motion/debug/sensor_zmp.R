...
names = c("ekf_zmp_x","com_x","pre_x","zmp_x","sensor_zmp_x (R)")
cols = c("1","2","3","4","5")
...
points(dat$time-.2,dat$com_x +(310./9.8)*dat$accX,type="l",col=5)
...
names = c("ekf_zmp_y","com_y","pre_y","zmp_y","sensor_zmp_y (R)")
cols = c("1","2","3","4","5")
...
points(dat$time-.2,dat$com_y +(310./9.8)*dat$accY,type="l",col=5)
