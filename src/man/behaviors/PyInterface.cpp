    ...
    class_<PyInterface, boost::shared_ptr<PyInterface>, boost::noncopyable>("Interface", no_init)
        ...
        .add_property("stiffStatus",
                      make_getter(&PyInterface::stiffStatus_ptr,
                                  return_value_policy
                                  <reference_existing_object>()))
        .add_property("behaviors",
                      make_getter(&PyInterface::behaviors_ptr,
                                  return_value_policy
                                  <reference_existing_object>()))
        ...
        .add_property("sharedBall",
                      make_getter(&PyInterface::sharedBall_ptr,
                                  return_value_policy
                                  <reference_existing_object>()))
        .add_property("naiveBall",
                      make_getter(&PyInterface::naiveBall_ptr,
                                  return_value_policy
                                  <reference_existing_object>()))
        .add_property("sharedFlip",
                      make_getter(&PyInterface::sharedFlip_ptr,
                                  return_value_policy
                                  <reference_existing_object>()))
        .add_property("sitDown",
                      make_getter(&PyInterface::sitDown_ptr,
                                  return_value_policy
                                  <reference_existing_object>()))
        .add_property("vision",
