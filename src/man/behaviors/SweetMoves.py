...
#                  (-65.3, 38.0, -75.1, 89.6, 29.9, -15.9),
#                  (-65.3, -38.0, -75.1, 89.7, 29.8, 15.8),
#                  (-0.0, -90.0, -0.0, -0.0),
#                  0.4, 1, stiff.NORMAL_STIFFNESSES),

                 ((19.4, 22.8, 35.9, -10.9),
                  (-48.7, 25.1, -32.3, 82.3, -14.0, -10.4),
                  (-48.7, -24.3, -35.8, 87.6, -17.3, 12.0),
                  (15.6, -29.7, -30.8, 2.0),
                  0.4, 1, stiff.NORMAL_STIFFNESSES),
                 ...
                 # ((41.7, -21.4, 93.8, -17.7),
                 # (-67.4, 23.8, -77.2, 78.0, 46.9, 1.4),
                 # (-67.4, -36.0, -73.1, 58.8, 55.4, 8.7),
                 # (48.3, 21.4, -81.7, 8.7)

                 ((35.7, -7.6, 59.6, -30.8),
                 (-65.0, 13.4, -90.8, 60.6, 61.8, -2.5),
                 (-65.0, -16.4, -91.5, 67.9, 57.7, 7.4),
                 (41.2, 17.8, -65.4, 29.3),
                 0.5,1, stiff.NORMAL_STIFFNESSES),
                 ...
                 # ((18.3, -19.1, 85.3, -54.2),
                 #  (-65.5, 42.3, -78.5, 85.3, 35.0, -15.5),
                 #  (-65.5, -44.4, -73.1, 81.7, 35.5, 16.9),
                 #  (17.1, 18.3, -80.6, 52.4),
                 #  0.5,1, stiff.NORMAL_STIFFNESSES),
                 # )
                 ...
                 # arms out and squat
                 # ((20, 9.1, -30.6, -9.3),
                 #  (-57.9, 26.6, -30.5, 65.1, 1.6, -9.7),
                 #  (-57.9, -22.2, -29.7, 59.9, 7.2, 10.2),
                 #  (10.5, 4.5, -44.7, 2.5),
...
GOALIE_SQUAT_STAND_UP = (((-28.9, 17.5, 80.5, -1.7),
                           ...
                           # (-45.7, 21.8, -90.1, 65.7, 40.3, -4.8),
                           # (-45.7, -8.9, -87.4, 59.5, 47.5, -0.8),
                           (-24.3, -6.0, -104.7, 3.7),
