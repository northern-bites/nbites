...
STAND_UP_BACK = (
                 ...
                 ((109.9, 13.3, 15.3, -78.5),
                  (4.7, 25.1, 11.8, 91.8, 8.3, 8.7),
                  (4.7, -12.3, 14.3, 81.3, 15.6, 0.3),
                  (113.9, -4.3, -12.7, 75.3),
                  0.4,1, stiff.STANDUP_STIFFNESSES),
                 #hips arch and arms underneath

                 ((122.7, 9.2, 12.0, -89.6),
                  (9.9, 22.9, 24.7, 85.3, 8.5, 7.6),
                  (9.9, -11.2, 29.8, 71.5, 12.3, 1.6),
                  (121.5, -15.3, -14.9, 89.7),
                  0.2,1, stiff.STANDUP_STIFFNESSES),
                 #hips arch and arms underneath

                 ((102.6, 8.3, 32.0, -89.6),
                  (-5.6, 13.8, -8.3, 23.1, 10.0, 8.5),
                  (-5.6, -8.6, -14.2, 35.4, 20.7, -0.3),
                  (117.5, -9.0, -13.8, 84.6),
                  0.4,1, stiff.STANDUP_STIFFNESSES),
                 #fling feet forward for momentum
                 ...
                 ((120.9, 9.2, 16.6, -31.6),
                  (-30.4, 17.2, -91.5, 56.5, 53.3, 0.4),
                  (-30.4, -12.4, -87.0, 57.4, 57.0, 7.6),
                  (121.0, 6.9, -17.8, 2.2),
                  0.4,1, stiff.STANDUP_STIFFNESSES),
                 #take a seat
                 ...
                 ((122.2, 17.7, 26.4, -3.6),
                  (-48.4, 45.5, -81.2, 111.0, 3.2, 2.4),
                  (-48.4, -13.3, -14.1, 122.8, -50.4, 4.0),
                  (70.0, -14.4, 14.3, 1.6),
                  0.4,1, stiff.STANDUP_STIFFNESSES),
                  #shift weight 

                  ((99.1, 25.4, 24.6, -0.8),
                  (-59.0, 25.0, -73.3, 89.2, 10.6, -9.7),
                  (-59.0, -9.9, -24.4, 123.3, -60.0, 6.9),
                  (62.9, -30.9, -9.8, 11.7),
                  0.5,1, stiff.STANDUP_STIFFNESSES),
                  #move to right foot

                  ((123.7, 52.6, -84.5, -28.3),
                  (-46.8, 44.2, -54.1, 64.5, 23.8, -25.0),
                  (-46.8, -3.2, -17.4, 123.4, -69.8, -1.8),
                  (42.7, -24.4, 64.5, 1.0),
                  0.4,1, stiff.STANDUP_STIFFNESSES),
                  #move to right foot

                  ((88.6, 2.6, -89.7, -9.3),
                  (-1.1, -0.3, -47.8, 123.6, -69.6, 0.0),
                  (-1.1, 1.1, -48.1, 123.3, -69.9, -0.2),
                  (91.8, -3.1, 82.5, 12.5),
                  0.4,1, stiff.STANDUP_STIFFNESSES),
                  #kneel

                 #  ((100.7, 7.1, 24.1, -1.1),
                 #  (-39.0, 26.8, -53.7, 123.5, -41.9, -14.5),
                 #  (-39.0, 1.3, -23.7, 123.4, -69.9, -4.0),
                 #  (116.5, 7.2, 96.6, 18.7),
                 #  0.3,1, stiff.STANDUP_STIFFNESSES),
                 #  # get to kneeling
                 ...
                 #  (-39.0, 1.3, -23.7, 123.4, -69.9, -4.0),
                 #  (116.5, 7.2, 96.6, 18.7),
                 #  30,1, stiff.STANDUP_STIFFNESSES),
