...
GOALIE_SQUAT = (((-0.0, 90.0, 0.0, 0.0),
                ...
                # goalieSquatDip
                # ((14.0, 16.4726637527, -1.848126246, -2.0190995413),
                #  (-69.1683831586, 55.0, -89.9108343849, 91.4049929073, 42.8887522137, -11.0719552106),
                #  (-69.1683831586, -55.0, -89.5640793411, 92.7281781345, 41.3994021445, 6.15482006488),
                #  (14.0, -16.0576731207, 0.437050144611, 2.81493952302),
                #  0.3, 1, stiff.NORMAL_STIFFNESSES),
                # # goalieSquatGetupPart1
                # ((-0.0, 0.0, 0.0, 0.0),
                #  (-49.9201041152, 24.3287533314, -24.5193819127, 124.276494062, -70.0521140146, 5.45169307096),
                #  (-49.9201041152, -44.1874737017, -14.8561122373, 108.812372045, -47.195459693, 20.0417147985),
                #  (-0.0, -0.0, -0.0, -0.0),
                #  0.4, 1, stiff.NORMAL_STIFFNESSES),
                ...
                # # goalieSquatGetupPart3
                # ((80.0, 80.0, 0.0, 0.0),
                #  (-35.0, -0.0, -50.0, 130.0, -50.0, -0.0),
                #  (-35.0, 20.0, -50.0, 130.0, -50.0, -27.0),
                #  (80.0, -80.0, 0.0, -0.0),
                #  0.1, 1, stiff.NORMAL_STIFFNESSES),
                )
