...
#did not work on zoe but dont know if it is her elbow or the
WAVE_RIGHT = (
  #Prep for wave
  ((85.9, 12.9, -47.6, -2.3),
  (1.9, 4.8, -57.5, 125.5, -70.1, -4.5),
  (1.9, -0.8, -57.6, 126.9, -70.6, 1.5),
  (25.7, -3.3, 68.9, 15.2),
  1,0,stiff.NORMAL_STIFFNESSES),

  #wave 1
  ((85.9, 12.9, -47.6, -2.3),
  (2.2, 4.8, -58.9, 125.5, -70.1, -4.3),
  (2.2, -0.8, -59.1, 126.9, -70.6, 1.4),
  (24.7, -1.8, 36.6, 84.8),
  1,0,stiff.NORMAL_STIFFNESSES),

  #wave 2
  ((85.9, 12.9, -47.6, -2.3),
  (2.6, 4.8, -60.6, 125.5, -70.1, -4.5),
  (2.6, -0.8, -60.6, 126.9, -70.6, 1.4),
  (29.2, -0.9, 95.0, 83.8),
  1,0,stiff.NORMAL_STIFFNESSES),
...
HIGH_FIVE_RIGHT = (
  #arm back
  ((87.4, 10.5, -48.3, -3.7),
  (8.6, 3.5, -63.5, 125.4, -70.2, -2.7),
  (8.6, 2.9, -64.6, 126.9, -70.6, -3.2),
  (110.6, -10.9, 79.4, 88.0),
  3,0,stiff.NORMAL_STIFFNESSES),

  # #arm forward a little
  # ((87.4, 10.5, -48.3, -3.7),
  # (8.8, 3.5, -63.3, 125.5, -70.1, -2.8),
  # (8.8, 2.8, -64.3, 126.9, -70.6, -3.2),
  # (31.6, -0.3, 87.7, 58.4),
  # 1,0,stiff.NORMAL_STIFFNESSES),

  #arm fully up
  ((87.4, 10.5, -48.3, -3.7),
  (8.7, 3.5, -63.5, 125.4, -70.1, -2.7),
  (8.7, 2.9, -64.2, 126.9, -70.6, -3.2),
  (-17.1, -0.3, 86.8, 12.8),
