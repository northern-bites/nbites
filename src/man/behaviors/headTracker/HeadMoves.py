...
WIDE_SNAP_PAN_WAIT_TIME = 1

WIDE_SNAP_PAN = (((-100.0, 25), WIDE_SNAP_PAN_TIME*2, 1, stiff.LOW_HEAD_STIFFNESSES),
            ((-100.0, 25), WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            ((-67.5, 25), WIDE_SNAP_PAN_TIME*2, 1, stiff.LOW_HEAD_STIFFNESSES),
            ((-67.5, 25), WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            ((-33.75, 25), WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            ((-33.75, 25), WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 0.0, 25), WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 0.0, 25), WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 33.75, 25), WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 33.75, 25), WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 67.5, 25), WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 67.5, 25), WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 33.75, 25), WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 33.75, 25), WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 0.0, 25), WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
...
WIDE_FAST_SNAP_PAN_TIME = 0.3
WIDE_FAST_SNAP_PAN_WAIT_TIME = 1
