...
WIDE_SNAP_PAN_WAIT_TIME = 0.4

WIDE_SNAP_PAN = (((-75.0, 25), WIDE_SNAP_PAN_TIME, 1, stiff.LOW_HEAD_STIFFNESSES),
            ((-75.0, 25), WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            ((-50.0, 25), WIDE_SNAP_PAN_TIME, 1, stiff.LOW_HEAD_STIFFNESSES),
            ((-50.0, 25), WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            ((-25.0, 25), WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            ((-25.0, 25), WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            ...
            (( 50.0, 25), WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 50.0, 25), WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 75.0, 25), WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 75.0, 25), WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 50.0, 25), WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 50.0, 25), WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 25.0, 25), WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
...
GAME_SET_WIDE_SNAP_PAN_WAIT_TIME = 0.4

GAME_SET_WIDE_SNAP_PAN = (((-75.0, 25), GAME_SET_WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            ((-75.0, 25), GAME_SET_WIDE_SNAP_PAN_WAIT_TIME, 1, stiff.LOW_HEAD_STIFFNESSES),
            ((-50.0, 25), GAME_SET_WIDE_SNAP_PAN_TIME, 1, stiff.LOW_HEAD_STIFFNESSES),
            ((-50.0, 25), GAME_SET_WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            ((-25.0, 25), GAME_SET_WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            ((-25.0, 25), GAME_SET_WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            ...
            (( 50.0, 25), GAME_SET_WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 50.0, 25), GAME_SET_WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 75.0, 25), GAME_SET_WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 75.0, 25), GAME_SET_WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 50.0, 25), GAME_SET_WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 50.0, 25), GAME_SET_WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 25.0, 25), GAME_SET_WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
...
GAME_SET_INITIAL_WIDE_SNAP_PAN_WAIT_TIME = 0.4

GAME_SET_INITIAL_WIDE_SNAP_PAN = (((-75.0, 25), 1,   1, stiff.LOW_HEAD_STIFFNESSES),
            ((-75.0, 25), GAME_SET_INITIAL_WIDE_SNAP_PAN_WAIT_TIME, 1, stiff.LOW_HEAD_STIFFNESSES),
            ((-50.0, 25), GAME_SET_INITIAL_WIDE_SNAP_PAN_TIME, 1, stiff.LOW_HEAD_STIFFNESSES),
            ((-50.0, 25), GAME_SET_INITIAL_WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            ((-25.0, 25), GAME_SET_INITIAL_WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            ((-25.0, 25), GAME_SET_INITIAL_WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 0.0, 25), GAME_SET_INITIAL_WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 0.0, 25), GAME_SET_INITIAL_WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 25.0, 25), GAME_SET_INITIAL_WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 25.0, 25), GAME_SET_INITIAL_WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 50.0, 25), GAME_SET_INITIAL_WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 50.0, 25), GAME_SET_INITIAL_WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 75.0, 25), GAME_SET_INITIAL_WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 75.0, 25), GAME_SET_INITIAL_WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 50.0, 25), GAME_SET_INITIAL_WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 50.0, 25), GAME_SET_INITIAL_WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 25.0, 25), GAME_SET_INITIAL_WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
...
GOALIE_WIDE_SNAP_PAN_TIME = 0.3
GOALIE_WIDE_SNAP_PAN_WAIT_TIME = 0.4

GOALIE_WIDE_SNAP_PAN = (((-110.0, 25), GOALIE_WIDE_SNAP_PAN_TIME, 1, stiff.LOW_HEAD_STIFFNESSES),
            ((-110.0, 25), GOALIE_WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            ((-82.5, 25), GOALIE_WIDE_SNAP_PAN_TIME, 1, stiff.LOW_HEAD_STIFFNESSES),
            ((-82.5, 25), GOALIE_WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            ((-55.0, 25), GOALIE_WIDE_SNAP_PAN_TIME, 1, stiff.LOW_HEAD_STIFFNESSES),
            ((-55.0, 25), GOALIE_WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            ((-27.5, 25), GOALIE_WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            ((-27.5, 25), GOALIE_WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 0.0, 25), GOALIE_WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 0.0, 25), GOALIE_WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 27.5, 25), GOALIE_WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 27.5, 25), GOALIE_WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 55.0, 25), GOALIE_WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 55.0, 25), GOALIE_WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 82.5, 25), GOALIE_WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 82.5, 25), GOALIE_WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 110.0, 25), GOALIE_WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 110.0, 25), GOALIE_WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 82.5, 25), GOALIE_WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 82.5, 25), GOALIE_WIDE_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 55.0, 25), GOALIE_WIDE_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
...
CENTER_SNAP_PAN = ((( 0.0, 25), CENTER_SNAP_PAN_TIME*2,   1, stiff.LOW_HEAD_STIFFNESSES),
            ...
            (( 33.75, 25), CENTER_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 33.75, 25), CENTER_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            ((-33.75, 25), CENTER_SNAP_PAN_TIME*2,   1, stiff.LOW_HEAD_STIFFNESSES),
            ((-33.75, 25), CENTER_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 67.5, 25), CENTER_SNAP_PAN_TIME*3,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 67.5, 25), CENTER_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 0.0, 25), CENTER_SNAP_PAN_TIME*2,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 0.0, 25), CENTER_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            ((-67.5, 25), CENTER_SNAP_PAN_TIME*2,   1, stiff.LOW_HEAD_STIFFNESSES),
            ((-67.5, 25), CENTER_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 33.75, 25), CENTER_SNAP_PAN_TIME*3,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 33.75, 25), CENTER_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            ((-33.75, 25), CENTER_SNAP_PAN_TIME*2,   1, stiff.LOW_HEAD_STIFFNESSES),
            ((-33.75, 25), CENTER_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 0.0, 25), CENTER_SNAP_PAN_TIME,   1, stiff.LOW_HEAD_STIFFNESSES),
            (( 0.0, 25), CENTER_SNAP_PAN_WAIT_TIME,   1, stiff.LOW_HEAD_STIFFNESSES))
