...
##
  ...
  ELSE( WIN32 )
    IF ( APPLE )
      SET( JAVA_INCLUDE /usr/lib/jvm/java-1.5.0-sun/include /usr/lib/jvm/java-1.5.0-sun/include/linux )
    ELSE ( APPLE )
      SET( JAVA_INCLUDE /System/Library/Frameworks/JavaVM.framework/Versions/1.5/Headers )
    ENDIF( APPLE )
  ENDIF( WIN32 )
