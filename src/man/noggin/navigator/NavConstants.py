...
OMNI_MAX_X_SPEED = speeds.OMNI_MAX_X
OMNI_MIN_X_SPEED = -OMNI_MAX_X_SPEED
OMNI_MAX_Y_SPEED = speeds.OMNI_MAX_Y
OMNI_MIN_Y_SPEED = -OMNI_MAX_Y_SPEED
OMNI_MAX_SPIN_SPEED = speeds.MAX_SPIN_WHILE_X_SPEED
OMNI_MIN_SPIN_SPEED = -OMNI_MAX_SPIN_SPEED

OMNI_GOTO_FORWARD_SPEED = OMNI_MAX_X_SPEED
OMNI_GOTO_STRAFE_SPEED = OMNI_MAX_Y_SPEED
