...
# Directions relative to perspective of own goalie
LANDMARK_MY_CORNER_LEFT_L_X = GREEN_PAD_X
LANDMARK_MY_CORNER_LEFT_L_Y = GREEN_PAD_Y + FIELD_WHITE_HEIGHT
LANDMARK_MY_CORNER_RIGHT_L_X = GREEN_PAD_X
LANDMARK_MY_CORNER_RIGHT_L_Y = GREEN_PAD_Y
LANDMARK_MY_GOAL_LEFT_T_X = GREEN_PAD_X
LANDMARK_MY_GOAL_LEFT_T_Y = CENTER_FIELD_Y + GOALBOX_WIDTH/2
LANDMARK_MY_GOAL_RIGHT_T_X = GREEN_PAD_X
LANDMARK_MY_GOAL_RIGHT_T_Y = CENTER_FIELD_Y - GOALBOX_WIDTH/2
LANDMARK_MY_GOAL_LEFT_L_X = GREEN_PAD_X + GOALBOX_DEPTH
LANDMARK_MY_GOAL_LEFT_L_Y = CENTER_FIELD_Y + GOALBOX_WIDTH/2
LANDMARK_MY_GOAL_RIGHT_L_X = GREEN_PAD_X + GOALBOX_DEPTH
LANDMARK_MY_GOAL_RIGHT_L_Y = CENTER_FIELD_Y - GOALBOX_WIDTH/2
LANDMARK_CENTER_LEFT_T_X = MIDFIELD_X
LANDMARK_CENTER_LEFT_T_Y = GREEN_PAD_Y + FIELD_WHITE_HEIGHT
LANDMARK_CENTER_RIGHT_T_X = MIDFIELD_X
LANDMARK_CENTER_RIGHT_T_Y = GREEN_PAD_Y
LANDMARK_CENTER_LEFT_CROSS_X = CENTER_FIELD_X
LANDMARK_CENTER_LEFT_CROSS_Y = CENTER_FIELD_Y + CENTER_CIRCLE_RADIUS
LANDMARK_CENTER_RIGHT_CROSS_X = CENTER_FIELD_X
LANDMARK_CENTER_RIGHT_CROSS_Y = CENTER_FIELD_Y - CENTER_CIRCLE_RADIUS
LANDMARK_OPP_CORNER_LEFT_L_X = GREEN_PAD_X + FIELD_WHITE_WIDTH
LANDMARK_OPP_CORNER_LEFT_L_Y = GREEN_PAD_Y + FIELD_WHITE_HEIGHT
LANDMARK_OPP_CORNER_RIGHT_L_X = GREEN_PAD_X + FIELD_WHITE_WIDTH
LANDMARK_OPP_CORNER_RIGHT_L_Y = GREEN_PAD_Y
LANDMARK_OPP_GOAL_LEFT_T_X = GREEN_PAD_X + FIELD_WHITE_WIDTH
LANDMARK_OPP_GOAL_LEFT_T_Y = CENTER_FIELD_Y + GOALBOX_WIDTH/2
LANDMARK_OPP_GOAL_RIGHT_T_X = GREEN_PAD_X + FIELD_WHITE_WIDTH
LANDMARK_OPP_GOAL_RIGHT_T_Y = CENTER_FIELD_Y - GOALBOX_WIDTH/2
LANDMARK_OPP_GOAL_LEFT_L_X = FIELD_WIDTH - GREEN_PAD_X - GOALBOX_DEPTH
LANDMARK_OPP_GOAL_LEFT_L_Y = CENTER_FIELD_Y + GOALBOX_WIDTH/2
LANDMARK_OPP_GOAL_RIGHT_L_X = FIELD_WIDTH - GREEN_PAD_X - GOALBOX_DEPTH
LANDMARK_OPP_GOAL_RIGHT_L_Y = CENTER_FIELD_Y - GOALBOX_WIDTH/2
...
LANDMARK_OPP_GOAL_RIGHT_POST = [LANDMARK_OPP_GOAL_RIGHT_POST_X,
                                ...
                                LANDMARK_OPP_GOAL_RIGHT_POST_ID]
LANDMARK_MY_CORNER_LEFT_L = [LANDMARK_MY_CORNER_LEFT_L_X,
                             LANDMARK_MY_CORNER_LEFT_L_Y]
LANDMARK_MY_CORNER_RIGHT_L = [LANDMARK_MY_CORNER_RIGHT_L_X,
                              LANDMARK_MY_CORNER_RIGHT_L_Y]
LANDMARK_MY_GOAL_LEFT_T = [LANDMARK_MY_GOAL_LEFT_T_X,
                           LANDMARK_MY_GOAL_LEFT_T_Y]
LANDMARK_MY_GOAL_RIGHT_T = [LANDMARK_MY_GOAL_RIGHT_T_X,
                           LANDMARK_MY_GOAL_RIGHT_T_Y]
LANDMARK_MY_GOAL_LEFT_L = [LANDMARK_MY_GOAL_LEFT_L_X,
                           LANDMARK_MY_GOAL_LEFT_L_Y]
LANDMARK_MY_GOAL_RIGHT_L = [LANDMARK_MY_GOAL_RIGHT_L_X,
                           LANDMARK_MY_GOAL_RIGHT_L_Y]
LANDMARK_CENTER_LEFT_T = [LANDMARK_CENTER_LEFT_T_X,
                          LANDMARK_CENTER_LEFT_T_Y]
LANDMARK_CENTER_RIGHT_T = [LANDMARK_CENTER_RIGHT_T_X,
                           LANDMARK_CENTER_RIGHT_T_Y]
LANDMARK_CENTER_LEFT_CROSS = [LANDMARK_CENTER_LEFT_CROSS_X,
                              LANDMARK_CENTER_LEFT_CROSS_Y]
LANDMARK_CENTER_RIGHT_CROSS = [LANDMARK_CENTER_RIGHT_CROSS_X,
                               LANDMARK_CENTER_RIGHT_CROSS_Y]
LANDMARK_OPP_CORNER_LEFT_L = [LANDMARK_OPP_CORNER_LEFT_L_X,
                             LANDMARK_OPP_CORNER_LEFT_L_Y]
LANDMARK_OPP_CORNER_RIGHT_L = [LANDMARK_OPP_CORNER_RIGHT_L_X,
                              LANDMARK_OPP_CORNER_RIGHT_L_Y]
LANDMARK_OPP_GOAL_LEFT_T = [LANDMARK_OPP_GOAL_LEFT_T_X,
                           LANDMARK_OPP_GOAL_LEFT_T_Y]
LANDMARK_OPP_GOAL_RIGHT_T = [LANDMARK_OPP_GOAL_RIGHT_T_X,
                           LANDMARK_OPP_GOAL_RIGHT_T_Y]
LANDMARK_OPP_GOAL_LEFT_L = [LANDMARK_OPP_GOAL_LEFT_L_X,
                           LANDMARK_OPP_GOAL_LEFT_L_Y]
LANDMARK_OPP_GOAL_RIGHT_L = [LANDMARK_OPP_GOAL_RIGHT_L_X,
                           LANDMARK_OPP_GOAL_RIGHT_L_Y]
