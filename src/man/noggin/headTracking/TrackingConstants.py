...
TRACKER_FRAMES_SEARCH_THRESH = 20 # ** # debugging values
TRACKER_FRAMES_STARE_THRESH = 30 # ** # debugging values
TRACKER_BALL_STARE_THRESH = 20
...
ELEVATION_OFFSET_LIMIT = 15
BEARING_OFFSET_LIMIT = 25
