...
LEFT_WING_MIN_Y = NogginConstants.CENTER_FIELD_Y - WING_Y_OFFSET
LEFT_WING_MAX_Y = NogginConstants.FIELD_WHITE_TOP_SIDELINE_Y - WING_Y_OFFSET
RIGHT_WING_MIN_Y = NogginConstants.FIELD_WHITE_BOTTOM_SIDELINE_Y + WING_Y_OFFSET
RIGHT_WING_MAX_Y = NogginConstants.CENTER_FIELD_Y + WING_Y_OFFSET
