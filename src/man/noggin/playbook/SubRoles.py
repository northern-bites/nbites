...
def pGoaliePosRight(team, workingPlay):
    ...
    dest = Location(PBConstants.GOALIE_RIGHT_X, PBConstants.GOALIE_RIGHT_Y)
    h = dest.headingTo(team.brain.ball)
...
def pGoaliePosLeft(team, workingPlay):
    ...
    dest = Location(PBConstants.GOALIE_LEFT_X, PBConstants.GOALIE_LEFT_Y)
    h = dest.headingTo(team.brain.ball)
...
def pRightDeepBack(team, workingPlay):
    ...
    dest = Location(PBConstants.DEEP_BACK_X, PBConstants.RIGHT_DEEP_BACK_Y)
    h = dest.headingTo(team.brain.ball)
