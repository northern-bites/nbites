...
MAX_ORBIT_Y_SPEED = speeds.OMNI_MAX_Y
MIN_ORBIT_Y_SPEED = -MAX_ORBIT_Y_SPEED
MIN_ORBIT_Y_MAGNITUDE = speeds.MIN_OMNI_MAGNITUDE
MAX_ORBIT_X_SPEED = speeds.OMNI_MAX_X
MIN_ORBIT_X_SPEED = -MAX_ORBIT_X_SPEED
MIN_ORBIT_SPIN_SPEED = speeds.MAX_SPIN_WHILE_X_SPEED
MAX_ORBIT_SPIN_SPEED = -MIN_ORBIT_SPIN_SPEED
