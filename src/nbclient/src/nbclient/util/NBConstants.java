...
public class NBConstants {
	...
	public static final String USER_CLASS_EXCEPTIONS = "~/.nbclient-exceptions.properties";
	public static final String USER_LOG_TO_VIEW_MAP = "~/.nbclient-views.properties";
