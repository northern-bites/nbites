...
public abstract class Field {
    ...
    public final double FIELD_GREEN_HEIGHT = (FIELD_WHITE_HEIGHT + 2*GREEN_PAD_Y);
    ...
    public int fieldToScreenY(int y) { 
        return (int)(FIELD_HEIGHT - y);// (int) (SCALE * ( FIELD_HEIGHT - y) ); 
    }
    ...
    drawing_on.setStroke(new BasicStroke((float)stroke));
        drawing_on.drawRect(fixXCoord(left_x), fixYCoord(bottom_y + height), fixWidth(width), fixHeight(height));
    }
