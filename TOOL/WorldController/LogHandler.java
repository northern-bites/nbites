...
public class LogHandler {
    ...
    public LogHandler(WorldController _wc, WorldControllerPainter _painter, DebugViewer _debugViewer) {
	// store WorldController,Field class instances locally
	wc = _wc;
	painter = _painter;
	debugViewer = _debugViewer;

	logBox = new LogBox(this, painter, 0, (int) (painter.getPreferredSize().getHeight() + 70));
	...
	playTimer = new Timer((int)1000./wc.DOG_FPS, taskPerformer);
    }
