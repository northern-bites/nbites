...
int main(int argc, char *argv[]) {
    ...
    object motion_module((
    handle<>(borrowed(PyImport_ImportModule("motion")))));
    object main_module((
    handle<>(borrowed(PyImport_ImportModule("main")))));

    object motion_namespace = motion_module.attr("__dict__");
